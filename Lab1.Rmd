...
legend("topright", inset=.02, legend=c("95% Equal Tail Cred. Int.", "95% HPDI"), col=c("red", "blue"), lty=c(1,1))
```

The 95% Highest Posterior Density Interval is [`r x_left_bound`, `r x_right_bound`], marked by the blue vertical lines on the plot above. It is shifted to the left compared to the 95% equal tail credible interval, which makes sense since the posterior distribution is skewed right.
